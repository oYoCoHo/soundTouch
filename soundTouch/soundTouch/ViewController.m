...
//    self.TempoLabel = [UILabel new];
//    self.TempoLabel.textColor = [UIColor blackColor];
//    self.TempoLabel.font = [UIFont systemFontOfSize:13];
//    [self.view addSubview:self.TempoLabel];
//    self.TempoLabel.frame = CGRectMake(20, 50, 200, 20);
//    
...
//    slider1.frame = CGRectMake(20, CGRectGetMaxY(self.TempoLabel.frame) + 10, 200, 20);
//    
//    //
//    self.PitchLabel = [UILabel new];
...
//    self.PitchLabel.frame = CGRectMake(20, 50, 200, 20);
//    
...
//    [self.view addSubview:slider1];
//    slider2.frame = CGRectMake(20, CGRectGetMaxY(self.TempoLabel.frame) + 10, 200, 20);
//    
//    //
